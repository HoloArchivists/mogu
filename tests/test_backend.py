...
class TestBackend(unittest.TestCase):
    ...
    def test_replace_utf8_values(self):
        test_dict = {
            ...
            "filelist.utf-8": ["Español 101.mkv", "ру́сский 202.mp4"],
        }
        expected_dict = {
            "hash": "2346ad27d7568ba9896f1b7da6b5991251debdf2",
            "title": "¡hola! ¿qué tal?",
            "filelist": ["Español 101.mkv", "ру́сский 202.mp4"],
        }
    ...
    def test_replace_invalid_xml_chars(self):
        ...
        self.assertEqual(backend.sanitize_string("ayy\uFFFElmao"), "ayy\uFFFDlmao")
        self.assertEqual(
            backend.sanitize_string("\x08ayy\x0clmao"), "\uFFFDayy\uFFFDlmao"
        )
        self.assertEqual(
            backend.sanitize_string("ayy\x08\x0clmao"), "ayy\uFFFD\uFFFDlmao"
        )
        self.assertEqual(
            backend.sanitize_string("ayy\x08\x08lmao"), "ayy\uFFFD\uFFFDlmao"
        )
