...
conn_group.add_argument(
    ...
    default=False,
    action="store_true",
    help="Query torrent info on sukebei.Nyaa.si",
)
...
INFO_TEMPLATE = (
    "Torrent #{id}: '{name}' ({formatted_filesize}) uploaded by {submitter}"
...
if __name__ == "__main__":
    ...
    if args.raw:
        ...
        if errors:
            ...
            info_str = INFO_TEMPLATE.format(
                formatted_filesize=formatted_filesize, flag_info=flag_info, **response
            )
